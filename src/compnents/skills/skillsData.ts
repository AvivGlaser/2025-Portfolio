...
import hubspotLogo from "../../assets/img/hubspot.jpg";
import mondayLogo from "../../assets/img/monday.png";
import jiraLogo from "../../assets/img/jira.png";
...
export const techSkills: Array<ILogo> = [
  ...
  { img: hubspotLogo, title: "HubSpot", alt: "hubspot-logo" },
  { img: mondayLogo, title: "Monday.com", alt: "monday-logo" },
  { img: jiraLogo, title: "Jira", alt: "jira-logo" },
