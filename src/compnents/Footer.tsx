...
//@ts-ignore
import pdfFile from "../assets/files/Aviv Glaser CV.pdf";
...
export function Footer() {
  ...
  useEffect(() => {
    const updateLogo = () => {
      ...
      if (bodyClasses.contains("whiteContrast")) {


        debugger;

        setLogoToUse(whiteLogo);
      } else {
        setLogoToUse(logo); 
      }
    };
  ...
  const links: Array<ILinks> = [
    {
      ...
      hiddenText:
        "Full-Stack Web Development course Certificate - External link to linkedin.com",
    },
    {
      href: pdfFile,
      ...
      <Container>
        <Row className="align-items-center">
          ...
          <Col size={12} sm={6} className="text-center text-sm-end">
            ...
            <p>Aviv Glaser Copyright 2026. All Rights Reserved ©</p>
